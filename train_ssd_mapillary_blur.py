...
for i in  np.arange(0.2, 1.1, 0.2):
    ...
    tb_logger = pl_loggers.TensorBoardLogger(save_dir="/graphics/scratch2/students/kornwolfd/ML_CV_practicalCourse/lightningLogs_RoadSigns/Mapillary", version='mapillary_ssd_blur'+str(i))
