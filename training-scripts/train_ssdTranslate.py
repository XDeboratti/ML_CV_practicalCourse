...
from data.augmentation import DataAugmentationTranslate
import numpy as np
import torch
...
for i in  np.arange(0.05, 0.16, 0.05):
    ...
    tb_logger = pl_loggers.TensorBoardLogger(save_dir="/graphics/scratch2/students/kornwolfd/lightningLogs_RoadSigns", version='translate_grid_'+str(i))
