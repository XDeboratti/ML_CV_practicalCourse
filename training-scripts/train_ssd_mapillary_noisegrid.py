...
for i in np.arange(0.01, 0.12, 0.02):
    ...
    tb_logger = pl_loggers.TensorBoardLogger(save_dir="/graphics/scratch2/students/kornwolfd/ML_CV_practicalCourse/lightningLogs_RoadSigns/Mapillary", version='mapillary_ssd_noise'+str(i))
