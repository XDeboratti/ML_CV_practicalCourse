...
class Detector(pl.LightningModule):
    ...
    def prepare_data(self):
        self.train_dataset = DFG_Dataset(self.scale, '/graphics/scratch2/students/kornwolfd/ML_CV_practicalCourse/data_RoadSigns/dfg/', phase='train')
        self.val_dataset = DFG_Dataset(self.scale, '/graphics/scratch2/students/kornwolfd/ML_CV_practicalCourse/data_RoadSigns/dfg/', phase='test')
...
for i in  np.arange(0.05, 0.16, 0.05):
    ...
    tb_logger = pl_loggers.TensorBoardLogger(save_dir="/graphics/scratch2/students/kornwolfd/ML_CV_practicalCourse/lightningLogs_RoadSigns", version='new_scale_grid_'+str(i))
