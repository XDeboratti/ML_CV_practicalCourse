#already given by the data set: visualize one image with their bounding box and annotation.
import json
import os
...
def visualize_gt(image_key, anno, color='green', alpha=125, font=None):
    ...
    with Image.open(os.path.join('all_images', '{:s}.jpg'.format(image_key))) as img:
...
if __name__ == '__main__':
    image_key = '_2YGWROcUgftOCk2EaBXPA'
